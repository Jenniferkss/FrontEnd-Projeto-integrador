...
import fotoAutora from '../../assets/foto-carolina.png'
    ...
    return (
        <div className={styles.page}>
            ...
            <section className={styles.contentSection}>
                <div className={styles.leftColumn}>
                    <div className={styles.badgeGroup}>
                        <div className={styles.badge}>Crítica Social</div>
            ...
            <footer className={styles.footerBottom}>
                © 2026 — Página dedicada à obra Quarto de Despejo - Desenvolvido por Intertexto.
            </footer>
        </div>
    );
};
