    ...
    return (
        <button
            ...
            <div className={styles.itemContent}>
                ...
                {video.livroTitulo && <div className={styles.itemTag}>📚 {video.livroTitulo}</div>}
            </div>
    ...
    useEffect(() => {
        ...
        const carregarVideoAulas = async () => {
            ...
            try {
                ...
                const videosEnriquecidos = Array.isArray(data)
                    ? data.map((video) => ({
                          ...video,
                          livroTitulo:
                              video.livro?.tituloPt ||
                              video.livro?.titulo ||
                              video.livroTitulo ||
                              null,
                      }))
            ...
            <main className={styles.shell}>
                ...
                <section className={styles.hero}>
                    <div className={styles.heroContent}>
                        ...
                        <h1 className={styles.title}>Vídeo Aulas</h1>
                        <p className={styles.lead}>
                            Assista a análises aprofundadas das maiores obras da literatura
                            brasileira. Conteúdo produzido por especialistas, com foco em
                            vestibulares e ENEM.
                        </p>
                    </div>
                ...
                {!loading && !error && videos.length === 0 && (
                    <section className={styles.emptyState}>
                        <p>
                            <strong>Nenhuma videoaula encontrada.</strong>
                        </p>
                        <p>
                            {filtroLivroId
                    ...
                    <section className={styles.contentGrid} id="video-player-section">
                        ...
                        <aside className={styles.playlistSection}>
                            <div className={styles.playlistHeader}>
                                ...
                                {filtroLivroId && (
                                    <div className={styles.playlistSub}>Filtrado por obra</div>
                                )}
                            </div>
                    ...
                    <section className={styles.supportSection}>
                        ...
                        <div className={styles.supportGrid}>
                            <article className={styles.supportCard}>
                                ...
                                <button className={styles.cardAction}>Baixar Material →</button>
                            </article>
                    ...
                    <footer className={styles.studyFooter}>
                        <div className={styles.footerContent}>
                            <div className={styles.footerTips}>
                                ...
                                <ul>
                                    <li>
                                        <strong>Anote citações diretas:</strong> Frases marcantes da
                                        obra são ótimas para argumentos em redações.
                                    </li>
                                    <li>
                                        <strong>Relacione com o contexto:</strong> Conecte os temas
                                        da obra com questões sociais atuais.
                                    </li>
                                    <li>
                                        <strong>Revise em intervalos:</strong> Reassista
                                        trechos-chave 24h e 7 dias após a primeira aula.
                                    </li>
                                </ul>
                            </div>
                            <div className={styles.footerAlert}>
                                ...
                                <p>
                                    Para provas, sempre correlacione a obra com seu movimento
                                    literário e contexto histórico. Isso faz diferença na
                                    argumentação!
                                </p>
                            </div>
                        </div>
